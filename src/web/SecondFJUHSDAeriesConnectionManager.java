 ...
 * @deprecated
 */
public final class SecondFJUHSDAeriesConnectionManager implements WebConnectionManager {
	
	private boolean loggedIn;
	
	public SecondFJUHSDAeriesConnectionManager() {
	...
	public static void main(String[] args) {
		new SecondFJUHSDAeriesConnectionManager();
	}
}
